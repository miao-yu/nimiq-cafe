...
export function FutureSupplyCurve({ title, subheader, data, categories, colors, sx, ...other }: Props) {
  ...
  const chartColors = colors || [theme.palette.primary.light];
  ...
  const chartOptions = useChart({
    ...
    tooltip: { y: { formatter: (value: number) => `${fShortenNumber(value).toUpperCase()} $NIM`, title: { formatter: () => '' } } },
  });
