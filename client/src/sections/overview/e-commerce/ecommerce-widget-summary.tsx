...
export function EcommerceWidgetSummary({ title, percent, text, chart, sx, ...other }: Props) {
    ...
    tooltip: {
      y: {
        formatter: (value: number) => {
          if (chart.numberFormat === 'short') {
            return fShortenNumber(value, chart.numberStyle ? { style: 'currency', currency: 'USD' } : {}).toUpperCase();
          } else if (chart.numberFormat === 'normal') {
