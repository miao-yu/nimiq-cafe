...
export function BlockSize({ title, subheader, data, categories, colors, sx, ...other }: Props) {
  ...
  const chartOptions = useChart({
    ...
    tooltip: { y: { formatter: (value: number) => fData(value).toUpperCase(), title: { formatter: () => '' } } },
  });
